// Schema Postgres (Supabase) — espelha schema.ts (SQLite) para a migração.
// Será promovido a schema.ts na Fase 1. Mantido separado por enquanto para não
// quebrar o app atual baseado em SQLite.
import {
  boolean,
  integer,
  pgTable,
